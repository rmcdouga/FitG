...
public enum BaseGameSovereign {
	Ascaill(0, 0, 0, "Ascaill, a Rhone dictator, exerts tyrannical control over the inhabitants of the industrial megalopolis on the planet Pronox. Backed by powerful Imperial support, with which he squeezes profitable production rates out of his Rhone subjects, Ascaill pro¬vides the Empire with numerous weapons and communication devices."),

...
public enum BaseGameAction implements Action {
	CARD_68(68, 
	...
	protected static final Set<BaseGameAction> ALL_ACTIONS = EnumSet.allOf(BaseGameAction.class);
	private static final ActionFactory actionFactory = new ActionEnumFactory();
	
	private BaseGameAction(int cardNumber, String urbanMissions, String urbanResult, String specialMissions, String specialResult, String wildMissions, String wildResult) {

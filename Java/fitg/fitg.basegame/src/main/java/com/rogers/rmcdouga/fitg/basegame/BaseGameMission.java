...
public enum BaseGameMission implements Mission {
	...
	protected static final Set<BaseGameMission> ALL_MISSIONS = EnumSet.allOf(BaseGameMission.class);
	...
	private BaseGameMission(int cardNumber, char mnemonic, String missionName, String description, String result) {
	...
	public MarkdownString result() {
	 ...
	 public static class MissionEnumFactory implements MissionFactory {
		...
		private Optional<BaseGameMission> getMissionEnumFromMnemonic(char mnemonic) {

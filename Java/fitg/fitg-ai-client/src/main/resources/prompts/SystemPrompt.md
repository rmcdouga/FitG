...
| adamstarlight | Adam Starlight | Adam_Starlight | REBEL |
| aganrafa | Agan Rafa | Agan_Rafa | REBEL |
| frunsentel | Frun Sentel | Frun_Sentel | REBEL |
| odenehobar | Odene Hobar | Odene_Hobar | REBEL |
| lymantok | Ly Mantok | Ly_Mantok | REBEL |
| vudotvodot | Vudot Vodot | Vudot_Vodot | REBEL |
| ranjayma | Ran Jayma | Ran_Jayma | REBEL |
| tourag | Tourag | Tourag | REBEL |
| raynerderban | Rayner Derban | Rayner_Derban | REBEL |
| kogus | Kogus | Kogus | REBEL |
| doctorsontag | Doctor Sontag | Doctor_Sontag | REBEL |
| scottrubel | Scott Rubel | Scott_Rubel | REBEL |
| boccanegra | Boccanegra | Boccanegra | REBEL |
| drakirgrebb | Drakir Grebb | Drakir_Grebb | REBEL |
| yarrolatac | Yarro Latac | Yarro_Latac | REBEL |
| professormareg | Professor Mareg | Professor_Mareg | REBEL |
| onestewoada | Oneste Woada | Oneste_Woada | REBEL |
| sidirganang | Sidir Ganang | Sidir_Ganang | REBEL |
| bridnemurcada | Bridne Murcada | Bridne_Murcada | REBEL |
| thysakymbo | Thysa Kymbo | Thysa_Kymbo | IMPERIAL |
| barca | Barca | Barca | IMPERIAL |
| saytar | Saytar | Saytar | IMPERIAL |
| telmen | Telmen | Telmen | IMPERIAL |
| jonkidu | Jon Kidu | Jon_Kidu | IMPERIAL |
| gelba | Gelba | Gelba | IMPERIAL |
| senatordermond | Senator Dermond | Senator_Dermond | IMPERIAL |
| redjac | Redjac | Redjac | IMPERIAL |
| jinvoles | Jin Voles | Jin_Voles | IMPERIAL |
| vanskatiea | Vans Ka Tie A | Vans_Ka_Tie_A | IMPERIAL |
